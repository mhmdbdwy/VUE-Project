                    ...
                    <div class="container-fluid p-0">
                        <div class="row">
                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                ...
                                <h4 style="margin: 10px 0">Hello {{ user.first_name }}, Your Month At A Glance</h4>
                            </div>
                            <div class="col-lg-2 ml-auto text-center month-button">
                                <div class="commonDiv" @click="changeDateText(2)">
                                    <p class="dayText">Weekly View</p>
                                </div>
                            </div>
                        </div>
                    </div>
...
.month-button.col-lg-6.text-center{
    padding: 20px 10px;
